                ...
                <div class="card card-light">
                    ...
                    <!-- /beginning of card-body -->
                      ...
                      <div class="card-body">
                          ...
                          @foreach ($subjects as $subject_id => $subject_item)
                          @foreach (\App\Models\Subject::where('id', $subject_id)->get() as $subject_is)
                          <h4>{{$subject_is->subject_name }}</h4>
                          <small>{{$subject_is->subject_name }} Analysis in stream.</small>
                           @endforeach
                        ...
                        <table class="table table-bordered table-hover " >
                         ...
                         @foreach($subject_item as $subject_data)
                           <tr>
                             <td>{{$subject_data->stream_name}}</td>

<x-app-layout>
    ...
    <div class="card card-light  ">
      <div class="card-header">
        <h3 class="card-title">View Class-Based Analytics</h3>
      </div>
        ...
        <div class="card-body">
         ...
         <div class="text-muted">
            <p class="card-text"> Use this section to view class analytics <br>
  ...
  <div class="tab-pane fade show active" id="pills-stream-analysis" role="tabpanel" aria-labelledby="pills-stream-analysis-tab">
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card card-light">
                <div class="card-header">
                  <h3 class="card-title">Class Based Analysis</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <form action="{{route('analytics.class_based_store')}}" method="post">
                  <div class="card-body">
                        @csrf
                        <div class="form-row">
...
<div class="col-md-6 form-group">
    ...
    @enderror
                  ...
                  <div class="card-footer">
                    <x-jet-button>Load <span id="grade_name"></span> Analytics</x-jet-button>
                  </div>
              </form>
              </div>

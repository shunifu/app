...
<div class="tab-pane fade show active" id="pills-stream-analysis" role="tabpanel" aria-labelledby="pills-stream-analysis-tab">
  <div class="row">
      <div class="col-md-12">
          ...
          <div class="card card-light">
              <div class="card-header">
                <h3 class="card-title">Stream Analysis</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form action="{{route('analytics.stream')}}" method="post">
                <div class="card-body">
                      @csrf
                      <div class="form-row">
...
<div class="col form-group">
  ...
  @foreach ($assessements_active as $assessement)
...
<div class="col form-group">
 ...
 <select class="form-control" name="analysis_indicator" id="analysis_indicator">
  ...
  @enderror
                        ...
                        <div class="col form-group" id="subject_div">

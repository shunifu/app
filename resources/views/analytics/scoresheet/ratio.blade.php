      ...
      <p class="card-text">
        <div id="chart-container2">FusionCharts XT will load here!</div>
                ...
                <td class="align-middle p-2"> {{ $load->salutation }} {{ $load->name }} {{ $load->lastname }}</td>
                            ...
                            <div class="col-md-6">
                                <div class="table-responsive">
                                    <h4 class="card-title text-bold  pb-3  ">Marks <small>entered</small></h4>
                                    <table class="table table-sm table-hover mx-auto table-bordered" id="students">
                ...
                <tr>
                <td>{{$loop->iteration}}</td>
                <td class="align-middle p-2"> {{ $mark->subject_name }}</td>
                <td class="align-middle p-2"> {{ $mark->salutation }} {{ $mark->name }} {{ $mark->lastname }}</td>
                <td class="align-middle p-2"> {{ $mark->mark}}</td>
                </tr>
                                            @empty
                                                No Analytics
                                            @endforelse

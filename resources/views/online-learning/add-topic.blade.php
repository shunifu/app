    ...
    <div class="card  ">
        ...
        <div class="card-body">
         ...
         <div class="text-muted">
            <p class="card-text"> This is where you can add a topic for each of the lessons <br>
                <hr>
                <ul>
                    <li>First select the stream</li>
                    <li>Secondly select the subject</li>
                    <li>Thirdly write the topic name</li>
                </ul>
        ...
        <form action="{{route('topics.store')}}" method="post">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="stream_id">
                      <option value="0">Select Teaching Load</option>

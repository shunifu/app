    ...
    <x-slot name="form">
        ...
        <div class="w-75">
            ...
            <div class="form-group">
                ...
                <x-jet-input id="middlename" type="text" class="{{ $errors->has('middlename') ? 'is-invalid' : '' }}" wire:model.defer="state.middlename" autocomplete="middlename" />
                <x-jet-input-error for="middlename" />
            </div>

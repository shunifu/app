...
<div class="card text-left">
  ...
  <div class="card-body no-print">
    ...
    <p class="card-text">
        ...
        This is where you will view student  reports. Please note that, it it take a few minutes for the report of the student(s) show.<p>
           ...
           <div class="form-group">
             ...
             <select multiple class="form-control" name="" id="">
               ...
               <option></option>
                   ...
                   <form action="/report/students" method="POST">
                    @csrf
                       <div class="row">
                         <div class="col-md-6">

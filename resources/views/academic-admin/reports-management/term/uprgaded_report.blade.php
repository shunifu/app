...
<?php
       ...
       WHERE
           term_averages.student_id =".$student." AND term_averages.term_id =2"));
...
?>
                        ...
                        @if ($pos_key=="class_based")

                        @php
                       $sql_piece="where term_averages.term=".$term." AND term_averages.student_class=".$classofstudent."";
                        @endphp
                      
                        @endif

                        @if ($pos_key=="stream_based")

                        @php
                        $sql_piece="where term_averages.term=".$term." AND term_averages.student_stream=".$stream."";
                        @endphp
...
{{-- Resolution: <span class=" text-bold">{{$student_term_data->final_term_status}}  </span> --}}
                        ...
                        <td>
                            ...
                            Assigned Subjects: <span class="text-bold">
                                ...
                                FROM student_loads 
                                WHERE student_loads.active=1 AND student_id = ".$student.""));
                                ?>

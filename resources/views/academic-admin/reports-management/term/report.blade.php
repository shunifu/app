                   ...
                   <table class="table table-sm table-bordered">
                    <thead class="btn-secondary">
                      ...
                      <tr>
                        ...
                        <td> {{$student_term_data->name}}'s term average was calculated based on the following criteria;
                            <ul>
...
echo '<span class="font-italic font-weight-light">'.substr($key_t->name, 0, 1).'  '.$key_t->lastname.' </span>';
                       ...
                       <div class="col">
                        <div id="signaturetitle">
                          ...
                          <div class="text-center">
<img class="img-fluid mx-auto " width="40" height="840" src="{{$school_is->base64}} " alt="">
                       </div>
                    </div>
                   ...
                   <center><small>&copy; 2022 Report generated by the <strong>Shunifu Intergrated School Management Platform</strong>-Developed by <strong>Innovazania</strong> based at the <strong>Royal Science & Technology Park</strong>  7689 0726 | 2517 9448</small></center>

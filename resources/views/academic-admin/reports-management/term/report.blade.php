...
@endif
                        ...
                        <td >
                            <center>
                                ...
                                @else
                                <img class="user-image img-circle elevation-1 " width="200px" height="230px"  src="{{$student_term_data->profile_photo_path}}" alt={{$student_term_data->name}} />
                                @endif
...
<table class="table table-sm table-bordered">
    <thead >
        <tr class="hope">
            ...
            @if ($school_is->school_type=="ieb-school")
            <th class="background">Class Tutor's Comment</th>    
            @else

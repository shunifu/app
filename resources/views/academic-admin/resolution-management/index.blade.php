        ...
        <div class="col-md-12">
            <div class="card card-light  ">
                <div class="card-header">
                    <h3 class="card-title">Resolution Management</h3>
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="text-muted">
                        <p class="card-text"> Use this view resolutions in student reports. <br>
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form action="{{ route('resolutions.load') }}" method="post">
                    <div class="card-body">
                        @csrf
                        <div class="form-row">
                            ...
                            <div class="col-md-4 form-group">
                                <x-jet-label>Session</x-jet-label>

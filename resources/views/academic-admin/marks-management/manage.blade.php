<x-app-layout>
            ...
            <div class="col-12 col-sm-6 col-lg-8">
                ...
                <p class="text-gray-700 mb-1 2h-base">{{$greetings}} {{\Spatie\Emoji\Emoji::grinningFace()}}{{Auth::user()->name}}<p>
                  ...
                  <p class="text-gray-700 mb-1 2h-base">
                    ...
                    Use this section to <span class="text-danger text-bold">DELETE</span> marks for students.
                    <ol>
                        <li>Select your teaching load </li>
                        <li>Select the assessement you want to delete marks for.</li>
                        <li>If you want to delete marks for all students, click on the delete all check box, but if you want to delete for some students click on checkbox of the student you want to delete the mark for.</li>
                        </ol> 
    ...
    <li class="nav-item" role="presentation">
        ...
        <li class="nav-item" role="presentation">
            <a class="nav-link bg-light" id="pills-section_analysis-tab"  href="/marks/manage" role="tab" aria-controls="pills-section_analysis" aria-selected="false">Manage Marks</a>
            </li>

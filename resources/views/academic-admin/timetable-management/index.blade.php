<x-app-layout>
    ...
    <div class="row">
                ...
                <div class="card-body">
                      ...
                      <div class="col-md-4 form-group">
                       ...
                       <select class="form-control" name="grade_id">
                        ...
                        <div class="col-md-4 form-group">
                            <x-jet-label>Select Day</x-jet-label>
        ...
        <p>Hi {{Auth::user()->name}}, you are adding teaching loads for <span class="text-bold"> {{$load_subject->subject_name}} </span> for students in <span class="text-bold">{{$load_class->grade_name}}</span> for academic year <span class="text-bold">{{$load_session->academic_session}}</span> 
        to continue, please select the students that you teach, if you teach all of them click on select all, but if you teach <span class="text-italics">some of them</span> click only on those you teach. </p>
              <p class="card-text">

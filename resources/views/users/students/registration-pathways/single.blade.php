<x-app-layout>
    ...
    <x-jet-input name="first_name" required value="{{ old('first_name') }}" placeholder="First Name" ></x-jet-input>
                       ...
                       <div class="col-md-4 form-group">
                        ...
                        <div class="col-md-4 form-group">
                            <x-jet-label>National ID <span style="color: red">*</span></label></x-jet-label>
                        ...
                        <div class="col-md-4 form-group">
                            <x-jet-label>Date of Birth <span style="color: red">*</span></label></x-jet-label>
                        ...
                        <div class="col-md-4 form-group">
                            <x-jet-label>Gender <span style="color: red">*</span></label></x-jet-label>
                            ...
                            <x-jet-label>Academic Year <span style="color: red">*</span></label></x-jet-label>
                            ...
                            <div class="col-md-3 form-group">
                                <x-jet-label>Class <span style="color: red">*</span></label></x-jet-label>
                               ...
                               <div class="col-md-3 form-group">
                                <x-jet-label>Student Status <span style="color: red">*</span></label></x-jet-label>
                               ...
                               <div class="col-md-3 form-group">
                                <x-jet-label>Student Sponsor <span style="color: red">*</span></label></x-jet-label>
                        ...
                        <div class="col-md-6 form-group">
                        <x-jet-label>Student Email Address<small>Optional</small></x-jet-label>

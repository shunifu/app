<x-app-layout>
                ...
                <div class="card-body">
                      ...
                      <table class="table table-sm table-hover mx-auto table-bordered">
                       ...
                       <tbody>
                           ...
                           <tr id="table_row">
    <td><input type="text" name="lastname[]" id="lastname"  class="form-control" placeholder="Student Surname" aria-describedby="lastname"><small id="lastname" required class="text-muted">Enter lastname of student</small></td>

    <td><input type="text" name="name[]" id="name" required class="form-control" placeholder="Student Name" aria-describedby="helpId"><small id="name" class="text-muted">Enter name of student</small></td>


    <td><input type="text" name="middlename[]" id="middlename" class="form-control" placeholder="Student Middlename" aria-describedby="middlename"><small id="middlename" class="text-muted">Enter middlename of student</small></td>
    ...
    <td><input type="text" name="parent_cell[]" id="parent_cell" class="form-control" placeholder="Parent Cell" aria-describedby="parent_cell"><small id="parent_cell" class="text-muted">Enter Parent Cell</small></td>

    <td><input type="text" name="parent_email[]" id="parent_email" class="form-control" placeholder="Parent Email" aria-describedby="parent_email"><small id="parent_cell" class="text-muted">Enter Parent Cell</small></td>

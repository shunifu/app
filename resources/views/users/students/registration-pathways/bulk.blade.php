...
<button class="btn btn-success"  type="button" id="add_more"><i class="fa fa-circle"></i> Add More Students</button>
        ...
        <script>
          $(document).ready(function () {
              ...
              $('#add_more').click(function (e) {
                ...
                <div class="d-flex  btn btn-link" id="remove-div" type="button" >

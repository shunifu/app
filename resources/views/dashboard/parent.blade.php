    ...
    <div class="col">
      <div class="card bg-gradient-white card-img-holder text-secondary card-rounded card-faded">
        <div class="card-body">
          ...
          <h4 class="font-weight-normal ">Child's Academics <i class="mdi mdi-chart-line mdi-20px float-right"></i>
          </h4>
    ...
    <div class="col">
        <div class="card bg-gradient-white card-img-holder text-secondary card-rounded card-faded">
          <div class="card-body">
            ...
            <h4 class="font-weight-normal ">Child's Attendance</h4>
        ...
        <div class="card bg-gradient-white card-img-holder text-secondary card-rounded card-faded">
          <div class="card-body">
            ...
            <h4 class="font-weight-normal "> School Fees
            </h4>
        ...
        <div class="card bg-gradient-white card-img-holder text-secondary card-rounded card-faded">
          <div class="card-body">
              <img src="https://prium.github.io/falcon/v2.8.2/default/assets/img/illustrations/corner-1.png" class="card-img-absolute" alt="circle-image">
            <h4 class="font-weight-normal ">School Activities
            </h4>
               <div class="card-footer text-muted">
                <a href="#">View More</a>
            </div>

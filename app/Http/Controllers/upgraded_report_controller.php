...
class ReportController extends Controller
{
...

    {
        ...
        return view('academic-admin.reports-management.term.index', compact('terms','streams','classes','sections'));
...
//Retrieve via return and display
// flash()->overlay(' 63%.  Upgrade in progress...');
// return redirect()->back();
        ...
        $term=$request->term;
        $column_color=$request->column_color;
...
//  dd($subject_average);
    ...
    where student_subject_averages.student_id = ".$student." AND student_subject_averages.term_id=".$term."   AND subjects.subject_id ".$non_contributing_subject."

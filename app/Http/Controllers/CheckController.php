...
class CheckController extends Controller
{
    ...
    public function view_students($id){
        ...
        ->select('teaching_loads.id','student_loads.student_id', 'users.name', 'users.lastname', 'users.middlename', 'users.profile_photo_path', 'teaching_loads.teacher_id', 'teaching_loads.subject_id', 'class_id', 'teaching_loads.session_id')
        ->get();

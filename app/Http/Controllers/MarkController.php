...
//ADD assessement bani
    ...
    //   dd($teachingLoad);
        ...
        grades.grade_name,
        subjects.subject_name, 
     	(SELECT COUNT(*) from student_loads WHERE  student_loads.teaching_load_id=teaching_loads.id AND teaching_loads.active=1 AND student_loads.active=) as total_loads,

...
if($outcome=="scoresheet"){
  ...
  //Beginning of Stream-Based scoresheet

  $assessement_scoresheet=DB::select("CALL testScoresheet()");

  return $assessement_scoresheet;
  //view('analytics.insights.assessement-insights.scoresheet');

 
//End of Stream-based scoresheet

  //Beginning of Class-Based Scoresheet



  //End of Class-Based Scoresheet
